...
obj['id'+count] = zetables['id'+count] = new c_draw(wB*1, wB*3, 0, 0, count++, ['collision', 'opponent','stol'], 0, -wB*1.3, wB*2, wB*0.7);
obj['id'+count] = zetables['id'+count] = new c_draw(wB*7, wB*2, 0, 0, count++, ['collision', 'opponent','skaf'], 0, -wB*1.3, wB*2, wB*0.7);
obj['id'+count] = zetables['id'+count] = new c_draw(wB*4, wB*4, 0, 0, count++, ['collision', 'opponent','styl'], 0, -wB*1.3, wB*2, wB*0.7);
